...
public class Exercises_Tests {
    ...
    void myMethodTest(int num1, int num2, boolean expected){
        Assertions.assertEquals(expected, Exercises.myMethod(num1, num2));
    }
   ...
   @ParameterizedTest
    ...
    public void anotherMethodTest2(int x, int y, int expResult){
    ...
    @ParameterizedTest
    @CsvSource({
        "I would like a pony, Doesn't start with H",
        "Help, Starts with H",
        "hello, Starts with H"
    })
