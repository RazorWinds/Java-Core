...
public class AppTests {
    ...
    @DisplayName("@Parameterized - CSV Source")
    public void timeBoundryTest5(String greetingMessage, int timeBoundry) {
        Assertions.assertEquals(greetingMessage, Refactoring.getMessage(timeBoundry));
    }
}
